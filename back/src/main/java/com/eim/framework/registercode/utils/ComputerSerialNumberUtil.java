...
public class ComputerSerialNumberUtil {
...
//            System.out.println("diskNumber : " + diskNumber);
            ...
            String cpuId = ComputerSerialNumberUtil.getCPUSerial();
            String mainBoard = ComputerSerialNumberUtil.getMotherboardSN();
            String disk = ComputerSerialNumberUtil.getHardDiskSN("c");
            String mac = ComputerSerialNumberUtil.getMac();
