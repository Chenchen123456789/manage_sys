    ...
    <el-row :gutter="10" class="mb8">
      <el-popover placement="bottom" trigger="click">
        ...
        <el-button
          ...
          slot="reference"
          type="warning"
          v-hasPermi="['energy:report_yearDosageOfWater:export']"
        >导出</el-button>
      </el-popover>
    </el-row>

    <el-table :data="yearDosageOfWaterList" show-summary size="mini" v-loading="loading">
      ...
      <el-table-column :label="dataTime" align="center">
        <el-table-column align="center" label="去年抄见" prop="preTimeValue" />
        <el-table-column align="center" label="今年抄见" prop="currentTimeValue" />
...
<script>
import {
  listYearDosageOfWater,
  exportYearDosageOfWater
...
export default {
  ...
  methods: {
    ...
    getList () {
      ...
      this.loading = true
      listYearDosageOfWater(this.queryParams).then(response => {
        ...
        this.yearDosageOfWaterList = list
    ...
    handleExport (type) {
      ...
      this.$confirm('是否确认导出水量年报数据项?', '警告', {
        confirmButtonText: '确定',
        cancelButtonText: '取消',
        type: 'warning'
      })
        .then(function () {
          return exportYearDosageOfWater(queryParams)
        })
        .then(response => {
