<template>
  <div class="app-container">
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['energy:company:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['energy:company:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
    ...
    <el-table size="mini" v-loading="loading" :data="companyList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="描述" align="center" prop="companyDescription" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px">
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="描述" prop="companyDescription">
          <el-input v-model="form.companyDescription" type="textarea" placeholder="请输入内容" />
        </el-form-item>
      </el-form>
